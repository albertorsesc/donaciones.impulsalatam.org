        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <p class="text-xl text-gray-600 mb-8 leading-relaxed">
                    En <span class="text-blue-600 text-xl font-bold">Impulsa<span
                                class="text-teal-500">LATAM</span></span>:
                    <span class="text-rose-400 text-lg font-bold">Donaciones</span>, conectamos las necesidades médicas
                    críticas con donantes solidarios a lo largo de Latinoamérica,
                    facilitando la donación directa de insumos, equipamiento y servicios médicos para mejorar el acceso
                    a la salud
                ...
                <div class="flex flex-col md:flex-row items-center gap-12 mb-16">
                    <div class="md:w-1/2">
                        ...
                        <p class="text-gray-600 mb-4">
                            <span class="text-blue-600 text-base font-bold">Impulsa<span
                                        class="text-teal-500">LATAM</span></span>:
                            ...
                            América Latina afrontan una severa escasez de recursos médicos que impacta a millones de
                            personas
                            en toda la región.
                        </p>
                        <p class="text-gray-600 mb-4">
                            La visión es convertir a <span class="text-blue-600 text-base font-bold">Impulsa<span
                                        class="text-teal-500">LATAM</span></span>
                            ...
                            formación técnica, el sector privado y organizaciones, trabajando juntos para apoyar a
                            quienes
                            más lo necesitan.
                        </p>
                        <p class="text-gray-600">
                            La misión de <span class="text-blue-600 text-base font-bold">Impulsa<span
                                        class="text-teal-500">LATAM</span></span>:
                            <span class="text-rose-400 text-base font-bold">Donaciones</span>
                    ...
                    <div class="md:w-1/2 mt-8 md:mt-0">
                        <div class="relative">
                            ...
                            <img src="https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?q=80&w=2070"
                                 alt="Equipo de Impulsa LATAM" class="relative rounded-lg shadow-lg w-full">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-600">Cada donación es rastreable y verificable, permitiendo a
                                        donantes y receptores seguir todo el proceso.</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-600">Creemos en el poder de la conexión directa entre personas,
                                        construyendo redes de apoyo duraderas.</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-600">Nuestro sistema de verificación garantiza que los recursos
                    ...
                    <div class="md:w-1/2 mt-8 md:mt-0">
                        <div class="relative">
                            ...
                            <img src="https://images.unsplash.com/photo-1576091160550-2173dba999ef?q=80&w=2070"
                                 alt="Trabajo comunitario" class="relative rounded-lg shadow-lg w-full">
                        </div>
                    </div>
                </div>
            </div>
